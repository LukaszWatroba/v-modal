...
!function(e){"use strict";function o(e){return{restrict:"AE",require:"^vDialog",replace:!0,transclude:!0,template:"<div ng-transclude></div>",compile:function(o){o.addClass(e.classes.dialogBody)}}}function t(e){return{restrict:"AE",require:"^vDialog",replace:!0,transclude:!0,template:"<div ng-transclude></div>",compile:function(o){o.addClass(e.classes.dialogFooter)}}}function l(e){return{restrict:"AE",require:"^vDialog",replace:!0,transclude:!0,template:"<div ng-transclude></div>",compile:function(o){o.addClass(e.classes.dialogHeader)}}}function i(o){return{restrict:"AE",require:"^vModal",replace:!0,transclude:!0,template:'<div><div><button ng-if="modalCtrl.hasClose()" ng-click="modalCtrl.close()"></button><div ng-transclude></div></div></div>',scope:{size:"@?",position:"@?"},controller:function(){},compile:function(t){t.addClass(o.classes.dialog);var l=e.element(t.find("div")[0]),i=t.find("button");return l.addClass(o.classes.dialogContent),i.addClass(o.classes.dialogClose).html("<span>"+o.closeButtonText+"</span>"),function(t,l,i,a){e.isDefined(t.vCenter)||(t.vCenter=e.isDefined(i.vCenter)),t.modalCtrl=a,l.addClass(o.classes.sizes[t.size||"medium"]),l.addClass(o.classes.positions[t.position||"center"])}}}}function a(o){return{restrict:"AE",replace:!0,transclude:!0,template:'<div ng-click="modalCtrl.close($event)" ng-transclude></div>',controller:n,controllerAs:"modalCtrl",scope:{close:"&?"},compile:function(t){return t.addClass(o.classes.modal),function(o,t,l){o.hasClose=e.isDefined(l.close)}}}}function n(o,t){var l=this;l.hasClose=function(){return o.hasClose},l.close=function(l){if(l){var i=e.element(l.target);i.hasClass(t.classes.modal)&&o.close()}else o.close()}}function s(o,t,l,i,a,n,s,r,d){return function(c){function u(e){return f.then(function(o){M||m(o,e)})}function m(a,n){if(M=e.element(a),0===M.length)throw new Error("The template contains no elements; you need to wrap text nodes");if(o.enter(M,D),D.addClass(d.classes.hasModalState),p=l.$new(),n)for(var s in n)p[s]=n[s];var r=i(C,{$scope:p});h&&(p[h]=r),t(M)(p)}function v(){var e=a.defer();return M?o.leave(M).then(function(){p.$destroy(),D.removeClass(d.classes.hasModalState),M=null,e.resolve()}):e.resolve(),e.promise}function g(){return!!M}if(!(!c.template^!c.templateUrl))throw new Error("Expected modal to have exacly one of either `template` or `templateUrl`");var f,p,C=(c.template,c.controller||e.noop),h=c.controllerAs,D=e.element(c.container||r[0].querySelector(d.containerSelector)),M=null;if(c.template){var $=a.defer();$.resolve(c.template),f=$.promise}else f=n.get(c.templateUrl,{cache:s}).then(function(e){return e.data});return{activate:u,deactivate:v,isActive:g}}}e.module("vModal.config",[]).constant("modalConfig",{closeButtonText:"Close",containerSelector:"body",classes:{modal:"Modal Modal--default",modalWithBackdrop:"Modal--withBackdrop",dialog:"Dialog Dialog--default",dialogContent:"Dialog-content",dialogHeader:"Dialog-header",dialogFooter:"Dialog-footer",dialogBody:"Dialog-body",dialogClose:"Dialog-close",hasModalState:"has-modal",sizes:{medium:"Dialog--sizeMd",large:"Dialog--sizeLg",small:"Dialog--sizeSm"},positions:{center:"Dialog--positionCenter",middle:"Dialog--positionMiddle","top-left":"Dialog--positionTopLeft","top-right":"Dialog--positionTopRight","bottom-left":"Dialog--positionBottomLeft","bottom-right":"Dialog--positionBottomRight"}}}),e.module("vModal.directives",["ngAnimate"]),e.module("vModal.services",["ngAnimate"]),e.module("vModal",["ngAnimate","vModal.config","vModal.directives","vModal.services"]),e.module("vModal.directives").directive("vDialogBody",o),o.$inject=["modalConfig"],e.module("vModal.directives").directive("vDialogFooter",t),t.$inject=["modalConfig"],e.module("vModal.directives").directive("vDialogHeader",l),l.$inject=["modalConfig"],e.module("vModal.directives").directive("vDialog",i),i.$inject=["modalConfig"],e.module("vModal.directives").directive("vModal",a),a.$inject=["modalConfig"],n.$inject=["$scope","modalConfig"],e.module("vModal.services").factory("vModal",s),s.$inject=["$animate","$compile","$rootScope","$controller","$q","$http","$templateCache","$document","modalConfig"]}(angular);